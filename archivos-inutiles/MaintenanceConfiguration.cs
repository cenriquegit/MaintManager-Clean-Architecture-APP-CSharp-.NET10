...
internal sealed class MaintenanceConfiguration : IEntityTypeConfiguration<Maintenance>
{
    public void Configure(EntityTypeBuilder<Maintenance> builder)
    {
        ...
        // assigned_to: columna agregada por 02_ajustes_fase1.sql [A1]
        ...
        builder.Property(m => m.UpdatedAt).HasColumnName("updated_at")
               .HasDefaultValueSql("CURRENT_TIMESTAMP");
        builder.Property(m => m.Statid).HasColumnName("statid").HasMaxLength(2).HasDefaultValue("AC");
        ...
        // Índices adicionales — agregados por 02_ajustes_fase1.sql [A1]
