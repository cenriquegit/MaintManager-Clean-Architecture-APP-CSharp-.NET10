...
public interface IMaintenanceRepository : IGenericRepository<Maintenance>
{
    ...
    Task<PagedResult<MaintenanceListItemDto>> GetPagedListItemsAsync(int page, int pageSize, string? status = null, int? assignedTo = null, CancellationToken ct = default);
