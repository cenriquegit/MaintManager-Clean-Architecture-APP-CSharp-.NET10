...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x02000302, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001f63, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001f62, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [882 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.58_name, ; name: libaot-Xamarin.AndroidX.Security.SecurityCrypto.dll.so
		ptr null; void* handle
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.63_name, ; name: libaot-Xamarin.Google.Crypto.Tink.Android.dll.so
		ptr null; void* handle
	}, ; 130
	%struct.DSOCacheEntry {
...
@.DSOCacheEntry.58_name = private unnamed_addr constant [55 x i8] c"libaot-Xamarin.AndroidX.Security.SecurityCrypto.dll.so\00", align 1
...
@.DSOCacheEntry.63_name = private unnamed_addr constant [49 x i8] c"libaot-Xamarin.Google.Crypto.Tink.Android.dll.so\00", align 1
