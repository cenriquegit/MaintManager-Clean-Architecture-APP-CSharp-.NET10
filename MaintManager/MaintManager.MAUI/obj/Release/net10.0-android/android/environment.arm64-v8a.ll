...
@aot_dso_cache = dso_local local_unnamed_addr global [927 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.88_name, ; name: libaot-System.Net.Http.Json.dll.so
		ptr null; void* handle
	}, ; 13
	%struct.DSOCacheEntry {
...
@.DSOCacheEntry.88_name = private unnamed_addr constant [35 x i8] c"libaot-System.Net.Http.Json.dll.so\00", align 1
